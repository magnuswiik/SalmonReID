...
import detection.SalmonDataset as SalmonDataset
...
def main():
    ...
    # Here we are testing the re-identification pipeline.
    # Pipeline testing assumptions are explained in the Master´s thesis by Magnus Wiik in chapter 6
    # All paths need to be changed according to your data setup
